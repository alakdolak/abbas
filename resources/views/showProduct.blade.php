...
{{--        <p>هزینه: {{$product->price}} سکه</p>--}}
{{--        <p>تعداد ستاره: {{$product->star}}</p>--}}
            ...
            <div class="c-product__config">
                <div class="c-product__engagement">
                    <div class="c-product__engagement-item">
                        <div class="c-product__engagement-rating">{{$product->star}}
                        </div>
                    </div>
                    <div class="c-product__engagement-item">
                        <div class="c-product__engagement-link" data-activate-tab="comments">{{$product->likes}} لایک کاربران</div>
                    </div>
                </div>
                <div class="c-product__config-wrapper">
                    <div class="c-product__directory">
                        <ul>
                            <li><span>دسته&zwnj;بندی</span> : <a class="btn-link-spoiler">گوشی موبایل</a>
                            </li>
                        </ul>
                    </div>
                        ...
                        <div class="js-seller-info-changable c-product__seller-box">
                            <div class="c-product__seller-row c-product__seller-row--seller c-product__seller-row--clickable js-seller-info-seller js-seller-variant">
                                <div class="c-product__seller-row-main c-product__seller-row-main--arrow-left">
                                    <div class="c-product__seller-first-line">فروشنده: <span>&nbsp;</span><span class="c-product__seller-name js-seller-name">{{$product->owner}}</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="c-product__seller-row c-product__seller-row--price">
                                <div class="c-product__seller-price-real">
                                    <div class="c-product__seller-price-raw js-price-value">{{$product->price}}</div>سکه
                                </div>
                            </div>
