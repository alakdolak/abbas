    ...
    @if(isset($tags))
        ...
        <div class="shopBox row">
            <div class="shopEachRow col-lg-12">
                ...
                <div class="shopEachRow col-lg-12">
                    <div class="shopOneBox col-lg-3 col-xs-6">
                        <div class="sh_mainBox">
                            <div class="sh_mainPic"></div>
                            <div class="sh_descript">
                                <div class="sh_descriptRow sh_title">پروژه ی ساخت کیف</div>
                                <div class="sh_descriptRow sh_priceBox">
                                    <div class="priceIcons coinIcon"></div>
                                    <div class="priceText">قیمت: 300 سکه</div>
                                </div>
                                <div class="sh_descriptRow sh_priceBox">
                                    <div class="priceIcons starIcon"></div>
                                    <div class="priceText">ستاره ی دریافتی: 20</div>
                                </div>
                            </div>
                        </div>
